...
fun Double.toBytes() = this.toString().toByteArray()
fun ByteArray.toDouble() = String(this).toDouble()

object Constants {
    const val DeviceName = "RPI3 CAR"

    val CAR_SERVICE = UUID.fromString("a7ad9c7d-8913-4f48-937d-5312dcfa5a83")
    val LEFT_ENGINE_STATE = UUID.fromString("6655785f-1c36-4e72-9d62-1d3626734caa")
    val RIGHT_ENGINE_STATE = UUID.fromString("8442e09d-ab2e-43a3-a6ba-c1d0e5c18f03")
